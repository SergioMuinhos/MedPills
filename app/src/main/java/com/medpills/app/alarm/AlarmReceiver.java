...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_MARK_TAKEN = "com.medpills.app.ACTION_MARK_TAKEN";
    public static final String ACTION_POSTPONE = "com.medpills.app.ACTION_POSTPONE";
    public static final String ACTION_REFRESH_WIDGET = "com.medpills.app.ACTION_REFRESH_WIDGET";
    ...
    private void handlePostpone(Context context, Intent intent) {
        ...
        if (alarmManager != null) {
            ...
            postponeIntent.setAction("com.medpills.app.ALARM_TRIGGER");
    ...
    private void showNotification(Context context, long scheduleId, long medicationId, String medName,
        ...
        Intent launchIntent = new Intent(context, com.medpills.app.ui.MainActivity.class);
